...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name) || empty($description) || empty($group)) {
        ...
        // Chuẩn bị câu truy vấn thêm danh mục vào cơ sở dữ liệu
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            if (result.status === 'success') {
                // Sau khi thêm thành công, tải lại danh sách danh mục
                loadCategories(); // Hàm này sẽ gọi AJAX tải lại danh sách danh mục
            }
        },
        error: function() {
...
// Hàm tải lại danh sách danh mục vào phần #dashboard-content
function loadCategories() {
    $.ajax({
        url: 'dashboard/categories/categories.php', // Tải lại danh sách danh mục
        method: 'GET',
        success: function(response) {
            // Cập nhật phần #dashboard-content với nội dung danh sách danh mục
